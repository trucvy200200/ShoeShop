...
<html>
    ...
    <body>
        ...
        <div class="intro-main">
            <div class="member">
                <img src="./assets/img/vh.png" width="100%" height="100%">
                <div class="content-menber">
                    <h4>Hello, my name is</h4>
                    <h1>Nguyen Van <span style="color:#F9004D">Hon </span></h1>
            ...
            <div class="member">
                ...
                <div class="content-menber">
                    <h4>Hello, my name is</h4>
                    <h1>Le Khanh <span style="color:#F9004D">Linh </span></h1>
                    <h3>I'am a Developer.</h3>
                </div>
            </div>
            <div class="member">
                ...
                <div class="content-menber">
                    <h4>Hello, my name is</h4>
                    <h1>Le Tan <span style="color:#F9004D">Loc </span></h1>
                    <h3>I'am a Developer.</h3>
                </div>
            </div>
            <div class="member">
                ...
                <div class="content-menber">
                    <h4>Hello, my name is</h4>
                    <h1>Vu Hoang <span style="color:#F9004D">Truc Vy </span></h1>
                    <h3>I'am a Developer.</h3>
                </div>
            </div>
        </div>
